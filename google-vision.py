...
for file_name in lists:
	with io.open("./imgs/"+file_name, 'rb') as image_file:
...
for im in images_labels:
	...
	for k in range(len(im)-1):
		...
		img.save('./labeled_imgs/'+im[0])

command="ffmpeg -r 0.5 -i ./labeled_imgs/img%03d.jpg labeled_videp.avi"
p=os.popen(command)
p.close()